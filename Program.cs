...
while (true)
{
    ...
    Console.WriteLine("Digite 3 para tirar a conta de um carro");
    Console.WriteLine("Digite 4 para ver a quantidade de vagas livres");
    Console.WriteLine("Digite 5 para ver a quantidade de carros estacionados");
    Console.WriteLine("Digite 6 para ver a capacidade de máxima de carros");
    Console.WriteLine("Digite 7 para listar carros estacionados");
    Console.WriteLine("Digite 8 para listar carros que saíram");
    Console.WriteLine("Digite 9 para listar todos os carros");
    ...
    switch (cases)
    {
        ...
        case 3:
            Console.Write("Digite a placa do carro: ");
            string lastPlate = Console.ReadLine();
            Console.WriteLine(parking.GetLastCar(lastPlate));
            Console.WriteLine();
            break;
        case 4:
